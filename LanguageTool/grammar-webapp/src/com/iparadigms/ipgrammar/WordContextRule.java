 ...
 * @author Robin Dunn
 */
public class WordContextRule extends EnglishRule {

    private VerbTool verbTool;
    
    private final Logger LOG = Logger.getLogger(WordContextRule.class.getName());

    public WordContextRule() throws java.io.IOException {
        /*if (messages != null) {
