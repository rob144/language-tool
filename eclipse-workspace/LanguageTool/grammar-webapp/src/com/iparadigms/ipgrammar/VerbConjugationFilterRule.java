 ...
 * @author Robin Dunn
 */
public class VerbConjugationFilterRule extends EnglishRule implements RuleFilter {

    private VerbTool verbTool;

    private final Logger LOG = Logger.getLogger(VerbConjugationFilterRule.class.getName());

    public VerbConjugationFilterRule() throws java.io.IOException {
        /*if (messages != null) {
    ...
    public RuleMatch acceptRuleMatch(RuleMatch match, Map<String, String> args, AnalyzedTokenReadings[] patternTokens) {
        ...
        for (AnalyzedTokenReadings t : patternTokens)
